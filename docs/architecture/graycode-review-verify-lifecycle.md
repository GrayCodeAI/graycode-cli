# Graycode Review and Verify Lifecycle

## Goal

Review and verification should be standard parts of Graycode's workflow, not optional bolt-ons.
...
Graycode should define when review and verification are:
