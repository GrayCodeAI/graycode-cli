...
`eagle` is the shared language spoken by Hawk and its engines.
...
- Hawk review storage and merlin/review bridge paths now consume neutral review/verify contracts
