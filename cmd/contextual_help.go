...
func (ch *ContextualHelp) registerAllEntries() {
	entries := []*HelpEntry{
		...
		},
		{
			...
			Detail:   "Reverts the last graycode action (commit, file edit, etc.) using safe snapshot-based rollback.",
		...
		},
		{
			...
			Detail:   "Opens the interactive configuration panel for graycode settings, model selection, and preferences.",
		...
		{
			Topic:    "/session",
			Summary:  "Manage graycode sessions",
			Detail:   "Start, stop, resume, or list graycode working sessions with full context preservation.",
		...
		// ─── Common Tasks ────────────────────────────────────────────
		{
			...
			Summary:  "Fixing failing tests with graycode",
		...
		{
			Topic:    "how to commit",
			Summary:  "Making commits with graycode",
		...
		{
			Topic:    "how to debug",
			Summary:  "Debugging with graycode AI assistance",
		...
		},
		{
			...
			Detail:   "Use /chat to discuss refactoring strategies, then graycode can apply changes. Use /snapshot before large refactors for safety.",
		...
		},
		{
			...
			Summary:  "Starting a new graycode session",
			Detail:   "Run graycode in your project directory to start a session. Your context is preserved across the session. Use /session to manage sessions.",
			Examples: []string{"graycode                 — start graycode in current dir", "/session new         — start fresh session", "/session resume      — resume last session"},
		...
		// ─── Error Explanations ──────────────────────────────────────
		{
			...
			Examples: []string{"/config              — paste API key in the config panel", "graycode credentials status — verify stored keys"},
		...
		},
		{
			...
			Detail:   "You have exceeded the API rate limit. Graycode will automatically retry with exponential backoff. Consider upgrading your plan for higher limits.",
		...
		},
		{
			...
			Detail:   "A merge conflict was encountered. Graycode can assist with conflict resolution using AI to understand both sides.",
		...
		},
		{
			...
			Detail:   "Graycode requires a git repository. Initialize one with git init or navigate to an existing repo.",
		...
		},
		{
			...
			Examples: []string{"/config              — paste API key in the config panel", "/config key remove   — remove a stored key", "graycode credentials status — list configured providers"},
		...
		},
		{
			...
			Detail:   "Configure which editor graycode uses when opening files for editing.",
		...
		},
		{
			...
			Detail:   "Choose the color theme for graycode terminal output. Supports light and dark terminal backgrounds.",
		...
		},
		{
			...
			Detail:   "Configure which shell graycode uses when running commands.",
		...
		},
		{
			...
			Detail:   "Runs agent tools in a mandatory isolated Docker container. If Docker is unavailable, tools remain locked and Graycode never falls back to the host.",
		...
		},
		{
			...
			Examples: []string{"graycode daemon start    — start the daemon", "graycode daemon status   — check daemon status", "graycode daemon stop     — stop the daemon"},
