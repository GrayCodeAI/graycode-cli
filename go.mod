...
require (
	...
	github.com/GrayCodeAI/eyrie v0.2.2-0.20260721084712-7296fe66d8d4
	github.com/GrayCodeAI/hawk-core-contracts v0.1.7-0.20260720234904-ceb290ffdc7e
...
require (
	...
	github.com/go-git/go-git/v6 v6.0.0-alpha.4 // indirect — TODO: alpha, API-unstable; upgrade when v6 reaches stable or pin back to go-git/v5
