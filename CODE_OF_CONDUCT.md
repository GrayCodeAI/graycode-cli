...
We — the maintainers and contributors of the hawk project — pledge to make
...
reported to the maintainers via the contact in `SECURITY.md` or by opening
a confidential GitHub Security Advisory. All complaints will be reviewed
