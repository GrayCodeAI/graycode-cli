...
// Extended event names (Year 0 PACK-04). Existing snake_case constants remain
// the primary EventType values used by Registry.Execute.
const (
...
// Mapping:
//
//	PreToolUse / pre_tool_use → pre_tool
...
func CanonicalEvent(s string) string {
	...
	// Prefer contracts vocabulary when available.
