...
// Useful for finding relationships between graycode, graycode-router, shrike, harrier, etc.
...
// If a symbol in graycode calls a symbol in graycode-router, this traces that cross-repo dependency.
...
// For example, graycode calling graycode-router functions.
