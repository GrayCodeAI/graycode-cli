...
`
	...
	engineIdx := strings.Index(result, `"github.com/GrayCodeAI/graycode-cli/internal/engine"`)
	toolIdx := strings.Index(result, `"github.com/GrayCodeAI/graycode-cli/internal/tool"`)
