...
type Settings struct {
	...
	// Model and Provider carry host-level selection only. Hawk does not persist
	// model/provider here; Eyrie owns the stored selection (SetActiveModel / SetActiveProvider).
