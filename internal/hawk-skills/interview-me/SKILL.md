---
name: interview-me
description: Extracts what the user actually wants instead of what they think they should want. Achieves this through one-question-at-a-time interview until ~95% confidence about the underlying intent. Use when an ask is underspecified or when you catch yourself silently filling in ambiguous requirements.
version: "1.0.0"
author: graycode
license: MIT
category: workflow
