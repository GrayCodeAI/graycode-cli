...
type mockSessionManager struct {
	startFunc func(ctx context.Context, repoPath, sessionID string) (SwiftSession, error)
	loadFunc  func(ctx context.Context, sessionID string) (SwiftSession, error)
}

func (m *mockSessionManager) Start(ctx context.Context, repoPath, sessionID string) (SwiftSession, error) {
	if m.startFunc != nil {
...
func (m *mockSessionManager) Load(ctx context.Context, sessionID string) (SwiftSession, error) {
	if m.loadFunc != nil {
...
func TestAddTag_StoresTags(t *testing.T) {
	...
	mgr := &mockSessionManager{
		startFunc: func(_ context.Context, _, _ string) (SwiftSession, error) {
			return sess, nil
		},
	}
