...
// Build renders the snapshot as the hawk trace diagnostic markdown, mirroring
// fx's `/trace` report structure. Every potentially secret field is masked.
